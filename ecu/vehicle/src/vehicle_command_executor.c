...
static void update_executor_lift_hydraulic_diagnostics(vehicle_executor_state_t *executor)
{
    ...
    executor->lift_leveling_entry_count =
        s_runtime.lift_hydraulic.lift_leveling_entry_count;
    executor->lift_leveling_complete_count =
        s_runtime.lift_hydraulic.lift_leveling_complete_count;
    executor->lift_range_direction_reject_count =
        s_runtime.lift_hydraulic.lift_range_direction_reject_count;
    executor->lift_sync_enable_count =
        s_runtime.lift_hydraulic.lift_sync_enable_count;
    ...
    executor->lift_level_target_position_counts =
        s_runtime.lift_hydraulic.lift_level_target_position_counts;
    executor->lift_level_stable_samples =
        s_runtime.lift_hydraulic.lift_level_stable_samples;
    executor->lift_below_safe_range_mask =
        s_runtime.lift_hydraulic.lift_below_safe_range_mask;
    executor->lift_above_safe_range_mask =
        s_runtime.lift_hydraulic.lift_above_safe_range_mask;
    executor->lift_mechanical_range_invalid_mask =
        s_runtime.lift_hydraulic.lift_mechanical_range_invalid_mask;
