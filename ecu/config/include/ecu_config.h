...
#define ECU_CANOPEN_LEG1_STEER_NODE_ID (0x02U)
#define ECU_CANOPEN_LEG2_DRIVE_NODE_ID (0x03U)
#define ECU_CANOPEN_LEG2_STEER_NODE_ID (0x04U)
#define ECU_CANOPEN_LEG3_DRIVE_NODE_ID (0x05U)
#define ECU_CANOPEN_LEG3_STEER_NODE_ID (0x06U)
#define ECU_CANOPEN_LEG4_DRIVE_NODE_ID (0x07U)
#define ECU_CANOPEN_LEG4_STEER_NODE_ID (0x08U)
#define ECU_CANOPEN_LIFT_BC2_FRONT_NODE_ID (0x09U)
#define ECU_CANOPEN_LIFT_BC2_REAR_NODE_ID  (0x0AU)
#define ECU_CANOPEN_HYDRAULIC_PUMP_NODE_ID (0x0BU)
...
#define ECU_CANOPEN_LIFT_FL_NODE_ID    ECU_CANOPEN_LIFT_BC2_FRONT_NODE_ID
#define ECU_CANOPEN_LIFT_FR_NODE_ID    ECU_CANOPEN_LIFT_BC2_FRONT_NODE_ID
#define ECU_CANOPEN_LIFT_RL_NODE_ID    ECU_CANOPEN_LIFT_BC2_REAR_NODE_ID
#define ECU_CANOPEN_LIFT_RR_NODE_ID    ECU_CANOPEN_LIFT_BC2_REAR_NODE_ID
