...
| 腿 1 转向 | 2 | BC 系列 | 正限位：J3 引脚 5 IN2；负限位：J3 引脚 6 IN3 |
| 腿 2 行走 | 3 | BC 系列 | 抱闸：J3 中的引脚 16 OUT1 |
| 腿 2 转向 | 4 | BC 系列 | 正限位：J3 引脚 5 IN2；负限位：J3 引脚 6 IN3 |
| 腿 3 行走 | 5 | BC 系列 | 抱闸：J3 中的引脚 16 OUT1 |
| 腿 3 转向 | 6 | BC 系列 | 正限位：J3 引脚 5 IN2；负限位：J3 引脚 6 IN3 |
| 腿 4 行走 | 7 | BC 系列 | 抱闸：J3 中的引脚 16 OUT1 |
...
| 腿 2 抬升 B 轴 | 9 | BC2 前驱动器 | 抱闸：引脚 17 OUT4；正限位：引脚 13 IN7_GP；负限位：引脚 14 IN8_GP |
| 腿 3 抬升 A 轴 | 10 | BC2 后驱动器 | 抱闸：控制信号 I/O 端子 J3 的引脚 8 OUT1；正限位：引脚 4 IN2_GP；负限位：引脚 5 IN3_GP |
| 腿 4 抬升 B 轴 | 10 | BC2 后驱动器 | 抱闸：引脚 17 OUT4；正限位：引脚 13 IN7_GP；负限位：引脚 14 IN8_GP |
| 液压站电机 | 11 | BC 系列 | 由 CANopen 速度/使能命令控制 |

BC2 的 A 轴限位读取 `0x2190` 的 IN2/IN3 位，B 轴限位读取 IN7/IN8 位。A 轴抱闸写 `0x2194` 的 OUT1 位，B 轴抱闸写 OUT4 位。伺服电机默认抱闸，当前接线为 OUT 输出低时释放刹车；代码中必须保留抱闸输出极性宏，便于现场发现驱动器输出配置相反时快速调整。
