...
CAN2_MOTION_ENCODER_COUNTS_PER_MOTOR_REV = 10_000.0
...
DRIVE_SPEED_MPS_TO_UNITS = (
    CAN2_MOTION_ENCODER_COUNTS_PER_MOTOR_REV
...
STEER_DEG_TO_COUNTS = (
    CAN2_MOTION_ENCODER_COUNTS_PER_MOTOR_REV * STEER_GEAR_REDUCTION / 360.0
)
...
class Motion8Debug:
    ...
    def velocity_units_to_mps(velocity_units: int, drive_sign: int = 1) -> float:
        ...
        wheel_rev_per_s = motor_counts_per_s / (
            CAN2_MOTION_ENCODER_COUNTS_PER_MOTOR_REV * DRIVE_GEAR_REDUCTION
        )
